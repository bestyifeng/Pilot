...
#include <cartoon_frag.h>

namespace Pilot
{
    void PCartoonPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PCartoonPass::setupDescriptorSetLayout()
    {
    ...
    void PCartoonPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, CARTOON_FRAG);
        ...
        pipelineInfo.subpass = _main_camera_subpass_cartoon;
    ...
    void PCartoonPass::setupDescriptorSet()
    {
    ...
    void PCartoonPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PCartoonPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Cartoon", {1.0f, 1.0f, 1.0f, 1.0f} };
